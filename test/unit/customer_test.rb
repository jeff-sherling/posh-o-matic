...
class CustomerTest < Minitest::Test
  ...
  def test_email_password
    ...
    TestLogger.log.info "Email+Password: #{email}"
  ...
  def test_missing_birthday
    ...
    TestLogger.log.info "Missing: #{missing}"
  ...
  def test_valid_customer
    ...
    TestLogger.log.info "Customer: #{valid_customer}"
  ...
  def test_mismatched_passwords
    ...
    TestLogger.log.info "Customer: #{mismatched}"
  ...
  def test_valid_minor
    ...
    TestLogger.log.info "Customer: #{minor}"
